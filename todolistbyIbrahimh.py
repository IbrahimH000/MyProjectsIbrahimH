...
root = tkinter.Tk()
root.title("To Do list by Ibrahim")
...
def save_task():
  tasks = listbox_tasks.get(0, listbox.tasks.size())
...
button_save_tasks = tkinter.Button(root, text="Save tasks", width=48, command=add_task)
